...
url = 'https://goprincetontigers.com/sports/mens-soccer/roster'
...
for player in players:
    ...
    #db.execute("INSERT INTO players (p_name, position, country, college, grade, number) VALUES(:name, :position, :country, :school, :grade, :number)", name = name, position = position, country = country, school = school, grade = grade, number = number)
